/**
  * userSyncv2 — Experiment (cloned from ConnectorSkills P0)
 *
...
const html = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/><title>userSyncv2</title><style>' + css + agentsCss() + '</style></head><body>'
  + '<div class="shell">'
  + nav()
...
fs.writeFileSync(path.join(outDir, 'userSyncV2.html'), html, 'utf-8');
console.log('Done: ' + path.join(outDir, 'userSyncV2.html'));
